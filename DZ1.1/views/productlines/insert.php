...
<div class="header">Dodaj novu produktnu liniju</div>
<div class="container">
<form action="?controller=productlines&action=insertproductline" method="POST">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="textDescription" >
  </div>
